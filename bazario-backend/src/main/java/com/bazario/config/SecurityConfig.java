...
import com.bazario.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Products — visitors can read
                .requestMatchers(HttpMethod.GET, "/api/v1/products/**").permitAll()
                // Categories — visitors can read
                .requestMatchers(HttpMethod.GET, "/api/v1/categories").permitAll()
                // Commands — visitors can POST (place order or demande info), operators manage
                .requestMatchers(HttpMethod.POST, "/api/v1/commands").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/v1/commands/demande-info").permitAll()
                // Comments — public read & post, admin delete via @PreAuthorize
                .requestMatchers(HttpMethod.GET, "/api/v1/products/*/comments").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/v1/products/*/comments").permitAll()
                // Uploads
